package io.quarkus.flyway.multitenant.deployment.devui;
...
import io.quarkus.flyway.multitenant.runtime.devui.FlywayDevUIRecorder;
import io.quarkus.flyway.multitenant.runtime.devui.FlywayJsonRpcService;

public class FlywayDevUIProcessor {

    @BuildStep(onlyIf = IsDevelopment.class)
    @Record(value = RUNTIME_INIT, optional = true)
    CardPageBuildItem create(FlywayDevUIRecorder recorder, FlywayMultiTenantBuildTimeConfig buildTimeConfig,
